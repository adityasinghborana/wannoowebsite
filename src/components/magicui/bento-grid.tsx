...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-black/[.2] group-hover:dark:bg-neutral-800/10" />
  </div>
);
